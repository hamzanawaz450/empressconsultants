        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="order-2 md:order-1">
              <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6">Video Library & Guides</h2>
        ...
        <div className="container-custom">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-2">Short Video Clips</h3>
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-2">Downloadable Guides</h3>
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-2">Practical Strategies</h3>
              <p className="text-sm sm:text-base text-gray-700">Easy-to-implement techniques for everyday challenges</p>
            </div>
          </div>
        </div>
      </section>
