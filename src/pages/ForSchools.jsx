  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="order-2 md:order-1">
              <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6">In-the-Moment Coaching</h2>
              ...
              <ul className="space-y-3 text-gray-700">
                ...
                <li className="flex items-start">
                  ...
                  <span>Staff coaching and professional development</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-primary-600 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>Data-driven intervention plans</span>
                </li>
              </ul>
            </div>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12">What You Can Expect</h2>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-2">Improved Staff Competence</h3>
              <p className="text-sm sm:text-base text-gray-700">Enhanced skills in behavioral support strategies</p>
            </div>
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md text-center">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-primary-600 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-7 h-7 sm:w-8 sm:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-2">Decreased Disruptions</h3>
              <p className="text-sm sm:text-base text-gray-700">Reduced behavioral incidents in the classroom</p>
            </div>
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md text-center">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-primary-600 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-7 h-7 sm:w-8 sm:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-2">Stronger Academic Engagement</h3>
              <p className="text-sm sm:text-base text-gray-700">Increased student participation and learning outcomes</p>
            </div>
          </div>
        </div>
      </section>
